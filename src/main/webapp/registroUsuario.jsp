...
<form method="post" class="container col-lg-7 col-md-11" action="registrarUsuarioController">
    ...
    <div class="form-floating mb-3">
        <input type="text" class="form-control" id="apellido" placeholder="Ocassio" value="${apellido}"  name="apellido"/>
        <label class="form-label" for="apellido">Apellido</label>
    </div>
    <div class="form-floating mb-3">
        <input type="email" class="form-control" id="email" placeholder="nombre.apellido@epn.edu.ec"  value="${email}" name="email"/>
