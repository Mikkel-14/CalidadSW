...
<form method="post" class="container col-lg-7 col-md-11">
    ...
    <div class="form-floating mb-3">
        <input type="number" class="form-control" id="codigoUnico" placeholder="202114788"/>
        <label class="form-label" for="codigoUnico">Código Único</label>
    </div>
    <div class="form-floating mb-3">
        <input type="text" class="form-control" id="nombre" placeholder="Anita"/>
        <label class="form-label" for="nombre">Nombre</label>
    </div>
    <div class="form-floating mb-3">
        <input type="text" class="form-control" id="apellido" placeholder="Ocassio"/>
